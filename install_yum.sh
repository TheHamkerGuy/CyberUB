...
if [[ -f ".env" ]] && [[ -f "my_account.session" ]]; then
  echo "It seems that CyberUserbot is already installed. Exiting..."
  exit
fi
...
case $install_type in
  1)
    ...
    echo
    echo "============================"
    echo "Great! CyberUserbot installed successfully and running now!"
...
[Unit]
Description=Service for Cyber Userbot
[Service]
Type=simple
...
EOL
  ...
  *)
    echo
    echo "============================"
    echo "Great! CyberUserbot installed successfully!"
