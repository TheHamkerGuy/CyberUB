...
common_params = {
    ...
    "device_model": f"CyberUserbot @ {gitrepo.head.commit.hexsha[:7]}",
...
async def main():
    logging.basicConfig(
        ...
        handlers=[logging.FileHandler("cyberlogs.txt"), logging.StreamHandler()],
        level=logging.INFO,
    )
    ...
    logging.info("CyberUserbot started!")
